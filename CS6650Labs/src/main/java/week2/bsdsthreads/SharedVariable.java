...
/**
 * @author Ian Gorton Multiple threads increment a value concurrently. Method is synchronized so
 * behaves correctly Demonstrates us of a count down latch to implement barrier synchronization
 */
